...
import { manageDescription, batchDelete, addDescription, deleteDescription, getDescriptionExcel } from '@/api/description'
...
export default {
  ...
  methods: {
    ...
    downloadFile() { // 点击导出按钮
      getDescriptionExcel().then(resp => {
        const fileName = '故障描述信息.xls'
